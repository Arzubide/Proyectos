...
<head>
    ...
    <link rel="icon" type="image/png" href="../resources/iconos/acuse.svg">
    <!-- Bootstrap CSS -->
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active fs-5" href="acuse.html">Acuse</a>
                    </li>
                    
                    <li class="nav-item">
                        <a class="nav-link fs-5" href="admin.php">Admin</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container content d-flex justify-content-center align-items-center mt-5 mb-4">
        <div class="row border rounded-5 p-3 bg-white shadow box-area">
            ...
            <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box">
                <div class="mb-3">
                    <img src="../resources/iconos/login.png" class="img-fluid mt-2" alt="icono login">
                </div>
            </div>
            <div class="col-md-6 right-box">
                <div class="row align-items-center">
                    <p class="fs-2 fw-bold text-center">Iniciar sesión</p>
                    <form id="acuse" method="post">
                        <div class="mb-3">
                          <label for="usuarioAcuse" class="form-label">Usuario</label>
                          <input type="text" class="form-control" id="usuarioAcuse" name="usuarioAcuse">
                        </div>
                        <div class="mb-3">
                          <label for="contraseñaAcuse" class="form-label">Contraseña</label>
                          <input type="password" class="form-control" id="contraseñaAcuse" name="contraseñaAcuse">
                        </div>
                        <div class="mb-3 mt-5">
    ...
    <script src="https://unpkg.com/just-validate@latest/dist/just-validate.production.min.js"></script>
    <script type="text/javascript" src="../js/acuseValidation.js"></script>
